...
| [**ADR-029**](./ADR-029-driver-identity-and-transportation-domain-modeling.md) | **Driver Identity & Transit Modeling** | `Accepted` 🟢 | Dedicated `drivers` table (optional unique `userId`); one `transportation` module |
