...
| :--------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------ |
| 🏗️ **Monorepo & Core** | Monorepo (`001`), Bun Runtime (`008`), Pure Bun (`009`), Templates (`010`), Dependencies (`011`), Type Contracts (`028`)                                                                                                | [View Specs ➔](./adr/README.md#-1-monorepo--core-toolchain)   |
| 💻 **Frontend & UI**   | React + Vite (`002`), Feature Structure (`005`), Mantine (`007`), App Shell (`012`), Shared Query Hooks (`025`)                                                                                                             | [View Specs ➔](./adr/README.md#-2-frontend--design-system)    |
| ⚡ **Backend & Data**  | REST API (`003`), Layered Model (`004`), Foreign Keys (`006`), Domain Modules (`013`), Soft Delete (`020`), JWT Sessions (`022`), RBAC (`024`), Testing (`026`)                                                  | [View Specs ➔](./adr/README.md#-3-backend--data-architecture) |
| 🐳 **DevOps & Infra**  | Docker Compose (`014`), `.dockerignore` (`015`), Layer Caching (`016`), Bind Mounts (`017`), All Interfaces (`018`), Incremental Compose (`019`), Env Config (`021`), Same-Origin Proxy (`023`), Production Build & Proxy (`027`) | [View Specs ➔](./adr/README.md#-4-infrastructure--devops)     |

<details>
<summary><b>📜 Click to Expand Complete ADR List (28 Records)</b></summary>
...
- [**ADR-024: Role-Based Access Control**](./adr/ADR-024-role-based-access-control.md)
- [**ADR-025: Shared Query Hooks & Cross-Feature Cache**](./adr/ADR-025-shared-query-hooks.md)
- [**ADR-026: API Testing Strategy**](./adr/ADR-026-api-testing-strategy.md)
- [**ADR-027: Production Build & Reverse Proxy**](./adr/ADR-027-production-build-reverse-proxy.md)
- [**ADR-028: API–Web Type Contract Strategy**](./adr/ADR-028-api-web-type-contracts.md)
